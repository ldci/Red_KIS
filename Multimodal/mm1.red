...
view win: layout [
	...
	button 100x50 font-size 14 str1	[b/text: "Games loaded" do-events/no-wait call/shell/wait msg1]
	button 100x50 font-size 14 str2	[b/text: "Starting game 1. Enjoy!" do-events/no-wait call/shell/wait msg2]
