...
;m3: #(n1 18 n2 76)			;--red 0.6.4
m3: #[n1 18 n2 76]			;--red 0.6.5 and R3
print [m3/n1 m3/n2]

;m4: #(n1 a n2 b)			;--red 0.6.4
m4: #[n1 a n2 b]			;--red 0.6.5 and R3
print [get m4/n1 get m4/n2]
print [reduce m4/n1 reduce m4/n2]

;m5: #(-2 -1 -1 -1 0 0 1 1 2 1)	;--red 0.6.4
m5: #[-2 -1 -1 -1 0 0 1 1 2 1]	;--red 0.6.5 and R3
